...
public class Entidad {
     ...
     * Entidad
     * 
     * Metodo constructor usado para crear los bloques y la barra
     ...
     * 
     */
    public Entidad(int iX, int iY ,Image imaImagen) {
        this.iX = iX;
        this.iY = iY;
     ...
     * 
     */
    public Entidad(int iX, int iY ,ImageIcon icoImagen) {
        this.iX = iX;
        this.iY = iY;
        imiIcono = icoImagen;
        this.iVelocidad = 1;    // default 1 en velocidad
     ...
     * 
     * @param aniObjeto es el objeto <code>Entidad</code> con el que se compara
     ...
     * colisiona
     * 
     * Metodo para revisar si un objeto <code>Entidad</code> colisiona con una
